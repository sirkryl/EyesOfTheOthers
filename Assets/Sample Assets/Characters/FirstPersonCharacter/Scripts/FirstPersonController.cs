...
namespace UnitySampleAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
		...
		public void ToggleWalking(bool enabled)
		{
			if(enabled)
				_isWalking = true;
			else
		...
		public void ToggleMouseLook(bool enabled)
		{
			if(!enabled)
			{
				_mouseLook.XSensitivity = 0.0f;
				_mouseLook.YSensitivity = 0.0f;
			}
			else
			{
				_mouseLook.XSensitivity = 15.0f;
				_mouseLook.YSensitivity = 15.0f;
			}
		}
